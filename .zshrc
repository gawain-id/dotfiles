...
export ZSH="/home/gawain/.oh-my-zsh"
...
# PYTHON_LOCAL_BIN
if [ -z $PYTHON_LOCAL_BIN ]; then
    export PYTHON_LOCAL_BIN=~/.local/bin
    export PATH=${PYTHON_LOCAL_BIN}:${PATH}
fi

# NPM_LOCAL_BIN
if [ -z $NPM_LOCAL_BIN ]; then
    export NPM_LOCAL_BIN=~/.npm-global/bin
    export PATH=${NPM_LOCAL_BIN}:${PATH}
fi

# COMPOSER VENDOR BIN
if [ -z $COMPOSER_VENDOR_BIN ]; then
